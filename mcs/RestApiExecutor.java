...
public class RestApiExecutor {
	...
	public static void main(String[] args) {
	  ...
	  executePostAPI(urlString, input);
	 ...
	 * @param input
	 */
	public static void executeGetAPI(String urlString, String input) {
		try {
	 ...
	 * @param input
	 */
	public static void executePostAPI(String urlString, String input) {
		try {
	 ...
	 * @param input
	 */
	public static void executePutAPI(String urlString, String input) {
		try {
